...
typedef enum { TYPE_COLUMNS_ID = 0, TYPE_COLUMNS_NAME = 1, TYPE_COLUMNS_AVAILABLE = 2, TYPE_COLUMNS_UNAVAILABLE = 3, TYPE_COLUMNS_TOTAL = 4, TYPE_COLUMNS_COMMENT = 5 } type_columns;
